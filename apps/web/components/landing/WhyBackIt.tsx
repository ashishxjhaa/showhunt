...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Side projects, weekend builds, early MVPs. ShowHunt is where builders discover what other builders are shipping.",
  },
]
        ...
        {reasons.map((reason) => {
          ...
          return (
            <div key={reason.title} className="paper-sheet p-6">
              <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--paper-accent-soft)] text-[#7C3AED]">
