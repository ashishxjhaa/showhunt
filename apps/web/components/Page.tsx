    ...
    <div>
        <div className="flex flex-col items-start gap-6 border-b border-[var(--app-rail-color)] p-5 sm:flex-row sm:items-center sm:gap-10 sm:p-8">
            <div className="relative shrink-0">
                <div className="absolute -inset-[5px] rounded-full bg-gradient-to-r from-[#F953C6] to-[#F9A8D4] opacity-75 blur-sm" />
            ...
            <div className="flex-1">
                <h1 className="text-3xl font-semibold tracking-tight text-[#F953C6]">{user?.fullName ?? ''}</h1>
        ...
        <div className="px-5 py-8 sm:px-8 sm:py-10">
            <h2 className="pb-4 text-2xl font-semibold tracking-tight text-[#F953C6] sm:text-3xl">My Listings</h2>
            {isLoading ? (
                        ...
                        <ProjectListingCard
                            ...
                            actionSlot={
                                <button
                                    ...
                                    title="Edit listing"
                                    className="flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--paper-border)] text-[var(--paper-muted)] transition-colors hover:border-[#F953C6]/50 hover:bg-[var(--paper-accent-soft)] hover:text-[#F953C6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F953C6]/40"
                                >
